      ...
      <main>
        <section style={{ padding: "88px 0 76px", background: "radial-gradient(circle at 85% 10%, #ffe4e9 0, transparent 35%), linear-gradient(180deg,#fff 0%,#f8fafc 100%)" }}>
          <div style={{ ...styles.container, display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 48, alignItems: "center" }}>
            <div>
              ...
              <h1 style={{ margin: 0, fontSize: "clamp(38px,6vw,66px)", lineHeight: .98, letterSpacing: "-0.055em", maxWidth: 700 }}>Controle seu negócio sem planilhas complicadas.</h1>
              <p style={{ color: "#475569", fontSize: "clamp(17px,2vw,21px)", lineHeight: 1.6, maxWidth: 650, margin: "26px 0" }}>Vendas, estoque, caixa, clientes e financeiro em um único sistema simples, online e acessível pelo celular ou computador.</p>
        ...
        <section style={{ ...styles.section, background: "#fff" }}>
          <div style={{ ...styles.container, maxWidth: 900 }}>
            <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 34px" }}>
              <div style={{ color: "#e94560", fontWeight: 950, fontSize: 13 }}>VEJA O ERPMINI FUNCIONANDO</div>
              <h2 style={{ fontSize: "clamp(30px,4vw,46px)", letterSpacing: "-0.045em", margin: "10px 0 14px" }}>Simples para usar no dia a dia</h2>
              <p style={{ color: "#64748b", fontSize: 17, lineHeight: 1.7 }}>Assista à demonstração e conheça o cadastro de produtos, vendas, clientes, estoque e financeiro.</p>
            </div>
        ...
        <section id="plano" style={{ ...styles.section, background: "#fff" }}>
          <div style={{ ...styles.container, maxWidth: 720 }}>
            <div style={{ textAlign: "center", marginBottom: 34 }}><div style={{ color: "#e94560", fontWeight: 950, fontSize: 13 }}>UM ÚNICO PLANO</div><h2 style={{ fontSize: "clamp(32px,4vw,48px)", letterSpacing: "-0.045em", margin: "10px 0" }}>Sem níveis, sem complicação</h2></div>
            <div style={{ ...styles.card, padding: "clamp(26px,6vw,48px)", border: "2px solid #e94560", position: "relative" }}>
              ...
              <div style={{ textAlign: "center" }}><div style={{ color: "#64748b", fontWeight: 800 }}>Tudo que está disponível no sistema</div><div style={{ margin: "15px 0 4px", display: "flex", justifyContent: "center", alignItems: "baseline", gap: 4 }}><span style={{ fontSize: 22, fontWeight: 900 }}>R$</span><strong style={{ fontSize: "clamp(52px,9vw,76px)", letterSpacing: "-0.06em" }}>39,90</strong></div><div style={{ color: "#64748b", marginBottom: 28 }}>por mês</div></div>
        ...
        <section style={{ padding: "70px 0", background: "linear-gradient(135deg,#e94560,#be123c)", color: "#fff", textAlign: "center" }}><div style={{ ...styles.container, maxWidth: 800 }}><h2 style={{ fontSize: "clamp(32px,5vw,52px)", lineHeight: 1.05, letterSpacing: "-0.05em", margin: "0 0 16px" }}>Seu negócio merece mais controle.</h2><p style={{ color: "#ffe4e6", fontSize: 18, lineHeight: 1.6, margin: "0 0 26px" }}>Centralize vendas, estoque, caixa e clientes por R$ 39,90 mensais.</p><button onClick={goCheckout} style={{ ...styles.button, background: "#fff", color: "#be123c" }}>Assinar agora</button></div></section>
      </main>
